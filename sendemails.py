...
class MultiEmails():
    ...
    def __init__(self, receiver, subject, alias=None, sender='1701213756@sz.pku.edu.cn'):
        """ Initialization """
    ...
    def attachment(self, file_path):
        ...
        for files in file_path:
            ...
            att["Content-Disposition"] = 'attachment; filename= "%s"' % os.path.basename(files)
            self.msg.attach(att)
    ...
    def send_email(self, password, server='imap.exmail.qq.com'):
        ...
        # set_debuglevel(): 1 - debug on; 0 - debug off
